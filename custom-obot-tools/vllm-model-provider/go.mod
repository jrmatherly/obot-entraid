module github.com/jrmatherly/obot-entraid/custom-obot-tools/vllm-model-provider
...
require (
	...
	github.com/jrmatherly/obot-entraid/custom-obot-tools/openai-model-provider v0.0.0
)
