...
import (
	...
	aproxy "github.com/jrmatherly/obot-entraid/custom-obot-tools/anthropic-model-provider/proxy"
	"github.com/jrmatherly/obot-entraid/custom-obot-tools/openai-model-provider/proxy"
)
