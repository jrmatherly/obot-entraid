...
1. **Create or Fork a Repository**: Start with the official [Obot MCP catalog](https://github.com/jrmatherly/mcp-catalog) or create your own repository
...
For examples and reference implementations, see the official Obot MCP catalog at [github.com/jrmatherly/mcp-catalog](https://github.com/jrmatherly/mcp-catalog).
